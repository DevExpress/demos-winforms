    ...
    Partial Public Class PrintControl
        ...
        Private Function CreatePrintersGallery() As GalleryDropDown
            ...
            Try
                ...
                For Each str As String In PrinterSettings.InstalledPrinters
                    ...
                    ps.PrinterName = str
                    If str.Equals(defaultPrinterName) Then
                        defaultPrinter = item
                    End If
                Next str
            Catch
        ...
        Private Sub OnMarginsGalleryItemCheckedChanged(ByVal sender As Object, ByVal e As GalleryItemEventArgs)
            ...
            If Me.printControl1.PrintingSystem IsNot Nothing Then
                ...
                Me.printControl1.PrintingSystem.PageSettings.LeftMargin = CInt(margins.Left)
                Me.printControl1.PrintingSystem.PageSettings.RightMargin = CInt(margins.Right)
                Me.printControl1.PrintingSystem.PageSettings.TopMargin = CInt(margins.Top)
                Me.printControl1.PrintingSystem.PageSettings.BottomMargin = CInt(margins.Bottom)
            End If
        ...
        Private Function GetPaperKind() As DXPaperKind
            Return CType(Me.ddbPaperSize.Tag, DXPaperKind)
        End Function
