...
Namespace DevExpress.DevAV.ViewModels
    ...
    Public Class OrderRevenueViewModel
        ...
        Private Property Parameter As Object Implements ISupportParameter.Parameter
            Get
                Return New Object() {SelectedItems, Format}
            End Get

            Set(ByVal value As Object)
                SelectedItems = CType(CType(value, Object())(0), IEnumerable(Of OrderItem))
                Format = CType(CType(value, Object())(1), RevenueReportFormat)
                OnLoaded()
            End Set
        End Property
        ...
        Private Function CreateTitle() As String
            Return String.Format("{0}", If(Format = RevenueReportFormat.Analysis, "Revenue Analysis", "Revenue"))
        End Function
