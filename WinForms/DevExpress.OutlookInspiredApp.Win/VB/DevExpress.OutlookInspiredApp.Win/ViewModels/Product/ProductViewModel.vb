...
Namespace DevExpress.DevAV.ViewModels
    ...
    Public Partial Class ProductViewModel
        ...
        Public ReadOnly Property LookUpEmployees As IEntitiesViewModel(Of Employee)
            Get
                Return GetLookUpEntitiesViewModel(Function(ByVal x As ProductViewModel) x.LookUpEmployees, Function(x) x.Employees)
            End Get
        End Property
        ...
        Public ReadOnly Property LookUpPictures As IEntitiesViewModel(Of Picture)
            Get
                Return GetLookUpEntitiesViewModel(Function(ByVal x As ProductViewModel) x.LookUpPictures, Function(x) x.Pictures)
            End Get
        End Property
