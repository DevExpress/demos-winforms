  ...
  <FilterInfo>
    ...
    <FilterCriteria>[RefundTotal] = [TotalAmount]</FilterCriteria>
        ...
        Public Property QuotesCustomFilters As Global.DevExpress.DevAV.ViewModels.FilterInfoList
            Get
                Return CType((Me("QuotesCustomFilters")), Global.DevExpress.DevAV.ViewModels.FilterInfoList)
            End Get
  ...
  <FilterInfo>
    ...
    <FilterCriteria>IsOutlookIntervalEarlierThisYear([Date])</FilterCriteria>
        ...
        Public Property EmployeesGroupFilters As Global.DevExpress.DevAV.ViewModels.FilterInfoList
            Get
                Return CType((Me("EmployeesGroupFilters")), Global.DevExpress.DevAV.ViewModels.FilterInfoList)
            End Get
        ...
        Public Property CustomersGroupFilters As Global.DevExpress.DevAV.ViewModels.FilterInfoList
            Get
                Return CType((Me("CustomersGroupFilters")), Global.DevExpress.DevAV.ViewModels.FilterInfoList)
            End Get
        ...
        Public Property ProductsGroupFilters As Global.DevExpress.DevAV.ViewModels.FilterInfoList
            Get
                Return CType((Me("ProductsGroupFilters")), Global.DevExpress.DevAV.ViewModels.FilterInfoList)
            End Get
...
<ArrayOfFilterInfo xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"">
  ...
  <FilterInfo>
    ...
    <FilterCriteria>[AssignedEmployee.FullName] = 'Samantha Bright'</FilterCriteria>
        ...
        Public Property TasksGroupFilters As Global.DevExpress.DevAV.ViewModels.FilterInfoList
            Get
                Return CType((Me("TasksGroupFilters")), Global.DevExpress.DevAV.ViewModels.FilterInfoList)
            End Get

            Set(ByVal value As Global.DevExpress.DevAV.ViewModels.FilterInfoList)
                Me("TasksGroupFilters") = value
            End Set
        End Property
        ...
        Public Property OrdersGroupFilters As Global.DevExpress.DevAV.ViewModels.FilterInfoList
            Get
                Return CType((Me("OrdersGroupFilters")), Global.DevExpress.DevAV.ViewModels.FilterInfoList)
            End Get
        ...
        Public Property QuotesGroupFilters As Global.DevExpress.DevAV.ViewModels.FilterInfoList
            Get
                Return CType((Me("QuotesGroupFilters")), Global.DevExpress.DevAV.ViewModels.FilterInfoList)
            End Get
