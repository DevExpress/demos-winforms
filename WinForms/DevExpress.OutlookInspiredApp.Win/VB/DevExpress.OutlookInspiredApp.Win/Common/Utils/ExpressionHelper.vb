...
Namespace DevExpress.DevAV.Common.Utils
    ...
    Public Class ExpressionHelper
        ...
        Private Class ValueHolder(Of T)
        ...
        Private Shared ReadOnly TraitsCache As Dictionary(Of Type, Object) = New Dictionary(Of Type, Object)()
        ...
        Private Shared Function ValidateMemberExpression(ByVal memberExpression As MemberExpression) As MemberExpression
            If IsNullableValueExpression(memberExpression) Then memberExpression = CType(memberExpression.Expression, MemberExpression)
        ...
        Private Shared Function IsNullableValueExpression(ByVal memberExpression As MemberExpression) As Boolean
            ...
            Return propertyInfo.PropertyType.IsValueType AndAlso propertyInfo.ReflectedType Is GetType(Nullable(Of )).MakeGenericType(propertyInfo.PropertyType) AndAlso Equals(propertyInfo.Name, "Value")
        End Function
    ...
    Public Class EntityTraits(Of TEntity, TPrimaryKey)
        ...
        ''' </summary>
        ''' <returns></returns>
        Private _GetPrimaryKey As Func(Of TEntity, TPrimaryKey), _SetPrimaryKey As Action(Of TEntity, TPrimaryKey), _HasPrimaryKey As Func(Of TEntity, Boolean)
