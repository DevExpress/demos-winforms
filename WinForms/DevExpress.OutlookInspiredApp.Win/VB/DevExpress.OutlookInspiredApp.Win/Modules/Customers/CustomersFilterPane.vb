...
Namespace DevExpress.DevAV.Modules
    ...
    Public Partial Class CustomersFilterPane
        Inherits BaseModuleControl
        Implements ISupportCompactLayout

        Private accordionPresenterCore As CustomerFilterAccordionPresenter
        ...
        Public ReadOnly Property Presenter As CustomerFilterAccordionPresenter
            Get
                Return accordionPresenterCore
            End Get
        End Property

        Protected Overridable Function CreateAccordionPresenter() As CustomerFilterAccordionPresenter
...
#Region "ISupportCompactLayout Members"
        ...
        Private Sub UpdateCompactLayout()
            btnNavigationContainer.Visible = Not compactLayout
        End Sub
#End Region
    End Class
End Namespace
