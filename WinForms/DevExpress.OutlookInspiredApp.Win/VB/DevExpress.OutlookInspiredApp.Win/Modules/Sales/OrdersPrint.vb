...
Namespace DevExpress.DevAV.Modules
    ...
    Public Partial Class OrdersPrint
        ...
        Protected Overrides Sub OnDisposing()
            ...
            report = Nothing
            Call ReleaseModuleReports(Of SalesReportType)()
            MyBase.OnDisposing()
        End Sub
        ...
        Public ReadOnly Property ViewModel As OrdersReportViewModel
            Get
        ...
        Private ReadOnly Property ParamShowHeader As Parameter
            Get
                Return GetParameter("paramShowHeader", GetType(Boolean))
            End Get
        End Property

        Private ReadOnly Property ParamShowFooter As Parameter
            Get
                Return GetParameter("paramShowFooter", GetType(Boolean))
            End Get
        End Property

        Private ReadOnly Property ParamShowComments As Parameter
            Get
                Return GetParameter("paramShowComments", GetType(Boolean))
            End Get
        End Property

        Private ReadOnly Property ParamShowStatus As Parameter
            Get
                Return GetParameter("paramShowStatus", GetType(Boolean))
            End Get
        End Property
        ...
        Private Sub ViewModel_ReportEntityKeyChanged(ByVal sender As Object, ByVal e As EventArgs)
            If Not(TypeOf report Is SalesInvoice) Then Return
            UpdatePreview()
        End Sub
        ...
        Private Sub UpdatePreview()
            If ViewModel Is Nothing OrElse ViewModel.ReportType = SalesReportType.None Then Return
        ...
        Private Function GetSettingsEditor(ByVal reportType As SalesReportType) As Control
            Select Case reportType
                Case SalesReportType.Invoice
                    Return New InvoiceSettingsControl(New List(Of Tuple(Of String, Boolean, Action(Of Boolean)))() From {New Tuple(Of String, Boolean, Action(Of Boolean))("Show Header", CBool(ParamShowHeader.Value), Sub(value) SetParameter(ParamShowHeader, value)), New Tuple(Of String, Boolean, Action(Of Boolean))("Show Footer", CBool(ParamShowFooter.Value), Sub(value) SetParameter(ParamShowFooter, value)), New Tuple(Of String, Boolean, Action(Of Boolean))("Show Status", CBool(ParamShowStatus.Value), Sub(value) SetParameter(ParamShowStatus, value)), New Tuple(Of String, Boolean, Action(Of Boolean))("Show Comments", CBool(ParamShowComments.Value), Sub(value) SetParameter(ParamShowComments, value))})
        ...
        Private Function CreateAndInitializeReport(ByVal reportType As SalesReportType) As XtraReport
            ...
            Select Case reportType
                ...
                Case SalesReportType.SalesByStore
                    report.DataSource = CollectionViewModel.GetSaleAnalysisInfos()
            End Select
        ...
        Private Sub PrintingSystem_AfterBuildPages(ByVal sender As Object, ByVal e As EventArgs)
            printSettingsControl.PrintEnabled = CType(sender, PrintingSystemBase).PageCount > 0
