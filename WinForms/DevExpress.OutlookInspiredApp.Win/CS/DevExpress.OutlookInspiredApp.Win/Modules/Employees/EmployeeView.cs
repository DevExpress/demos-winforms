namespace DevExpress.DevAV.Modules {
    ...
    public partial class EmployeeView : BaseModuleControl {
        ...
        public EmployeeView()
            ...
            svgYes = SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.EvaluationYes.svg"), asm);
            svgNo = SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.EvaluationNo.svg"), asm);
        ...
        void UpdateUI(Employee employee) {
            ...
            moduleLayout.Visible = (employee != null);
        }
