namespace DevExpress.DevAV.Modules {
    ...
    public partial class Products : BaseModuleControl, IRibbonModule, ISupportZoom, ISupportFiltersVisibilityChangedEvent {
        public Products()
        ...
        protected override void OnLoad(System.EventArgs e) {
            ...
            FilterPaneHelper.SetupFiltersPane(
               ParentViewModel,
               ViewModel,
               ModuleType.ProductsFilterPane,
               ModuleType.ProductsFilterPaneCollapsed,
        ...
        Size DefaultNavigationSize {
            get { return ScaleDPI.ScaleSize(new Size(180, navigationRoundedPanel.Height)); }
        }
