namespace DevExpress.DevAV.Modules {
    ...
    public partial class Orders : BaseModuleControl, IRibbonModule, ISupportZoom, ISupportFiltersVisibilityChangedEvent {
        public Orders()
        ...
        protected override void OnLoad(System.EventArgs e) {
            ...
            FilterPaneHelper.SetupFiltersPane(
               ParentViewModel,
               ViewModel,
               ModuleType.OrdersFilterPane,
               ModuleType.OrdersFilterPaneCollapsed,
        ...
        Size DefaultNavigationSize {
            get { return ScaleDPI.ScaleSize(new Size(230, navigationRoundedPanel.Height)); }
        }
        ...
        void InitEditors() {
            colPaymentStatus.ImageOptions.ImageUri.ResourceType = typeof(MainForm);
            colPaymentStatus.ImageOptions.ImageUri.Uri = FluentIconHelper.GetFluentIconName(statusResourcePath + "Payment.svg");
            colPaymentStatus.ColumnEdit = EditorHelpers.CreatePaymentStatusImageComboBox(LookAndFeel, null, gridControl.RepositoryItems);
            colShipmentStatus.ImageOptions.ImageUri.ResourceType = typeof(MainForm);
            colShipmentStatus.ImageOptions.ImageUri.Uri = FluentIconHelper.GetFluentIconName(statusResourcePath + "Shipment.svg");
