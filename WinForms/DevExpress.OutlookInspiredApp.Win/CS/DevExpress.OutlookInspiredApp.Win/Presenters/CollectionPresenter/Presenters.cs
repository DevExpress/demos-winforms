namespace DevExpress.DevAV.Presenters {
    ...
    public class TasksCollectionPresenter : TasksCollectionPresenter<EmployeeTask, long, IDevAVDbUnitOfWork> {
        public TasksCollectionPresenter(GanttControl gridControl, CollectionViewModel<EmployeeTask, long, IDevAVDbUnitOfWork> viewModel, Action<int> updateUIAction) 
            : base(gridControl, viewModel, updateUIAction) {
        }

        protected new TaskCollectionViewModel ViewModel {
            get { return base.ViewModel as TaskCollectionViewModel; }
        }
        protected override void SubscribeViewModelEvents() {
            base.SubscribeViewModelEvents();
            ViewModel.Reload += ViewModel_Reload;
