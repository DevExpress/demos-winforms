namespace DevExpress.DevAV.ViewModels {
    ...
    partial class OrderCollectionViewModel : ISupportMap, ISupportCustomFilters {
        ...
        protected override void OnSelectedEntityChanged() {
            ...
            this.RaiseCanExecuteChanged(x => x.ShowRevenueAnalysisReport());
        }
        ...
        public void ShowRevenueReport() {
            var data = QueriesHelper.GetRevenueReportItems(CreateUnitOfWork().OrderItems);
            ShowDocument<OrderRevenueViewModel>("OrderRevenueView", new object[] { data, RevenueReportFormat.Summary });
        }
        public bool CanShowRevenueAnalysisReport() {
            return SelectedEntity != null;
        }
        [Command]
        public void ShowRevenueAnalysisReport() {
            var data = QueriesHelper.GetRevenueAnalysisReportItems(CreateUnitOfWork().OrderItems, SelectedEntity.StoreId.Value);
            ShowDocument<OrderRevenueViewModel>("OrderRevenueView", new object[] { data, RevenueReportFormat.Analysis });
        }
        ...
        internal IEnumerable<SaleAnalysisInfo> GetSaleAnalysisInfos() {
