namespace DevExpress.DevAV {
    ...
    public static class AddressExtension {
        ...
        public static void ZoomTo(this DevExpress.Map.Dashboard.IZoomToRegionService zoomService, IEnumerable<Address> addresses, double margin = 0.25) {
            GeoPoint ptA = null;
            GeoPoint ptB = null;
        ...
        static void ZoomCore(DevExpress.Map.Dashboard.IZoomToRegionService zoomService, GeoPoint ptA, GeoPoint ptB, double margin) {
    ...
    public static class MapControlExtension {
        public static void Export(this MapControl mapControl, string imgPath) {
            mapControl.ExportToImage(imgPath, DevExpress.Drawing.DXImageFormat.Png);
            AppHelper.Open(imgPath);
        }
    }
}
