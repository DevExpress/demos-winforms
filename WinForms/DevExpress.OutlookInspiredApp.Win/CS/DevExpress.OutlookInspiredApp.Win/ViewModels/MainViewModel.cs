namespace DevExpress.DevAV.ViewModels {
    ...
    public class MainViewModel : IZoomViewModel {
        ...
        public Control GetNavigationModule(ModuleType moduleType) {
            Control filterPane = GetModule(moduleType, SelectedModuleViewModel) as Control;
            ViewModelHelper.EnsureModuleViewModel(filterPane, this);
            return filterPane;
        }
