namespace DevExpress.DevAV.ViewModels {
    ...
    public static class AnalysisPeriod {
        public static readonly DateTime Start = new DateTime(TutorialConstants.Now.Year - 3, 10, 1);
        public static readonly DateTime End = new DateTime(TutorialConstants.Now.Year, 09, 30);
