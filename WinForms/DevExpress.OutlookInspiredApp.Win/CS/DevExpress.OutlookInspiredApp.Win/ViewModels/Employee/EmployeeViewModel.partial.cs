namespace DevExpress.DevAV.ViewModels {
    ...
    partial class EmployeeViewModel : ISupportNewChid {
        public new bool IsNew() { return base.IsNew(); }
        EmployeeContactsViewModel contactsCore;
        public EmployeeContactsViewModel Contacts {
            get {
                if(contactsCore == null)
                    contactsCore = EmployeeContactsViewModel.Create().SetParentViewModel(this);
                return contactsCore;
            }
        }
