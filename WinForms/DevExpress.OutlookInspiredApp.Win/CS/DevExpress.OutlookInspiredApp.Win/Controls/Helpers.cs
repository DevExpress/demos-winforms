...
namespace DevExpress.DevAV {
    ...
    static class AppHelper {
        ...
        public static SvgImage AppIcon {
            get { return DevExpress.Utils.ResourceImageHelper.CreateSvgImageFromResources("DevExpress.DevAV.Resources.AppIcon.svg", typeof(MainForm).Assembly); }
        }
        static Image img;
    ...
    static class GridHelper {
        public static void SetFindControlImages(GridControl grid) {
            ...
            if(fControl != null) {
                ...
                fControl.FindEdit.EditValueChanged += (s, e) => {
                    ...
                    finally { edit.Properties.EndUpdate(); }
        ...
        internal static Color GetTransparentRowForeColor(LookAndFeel.UserLookAndFeel lf) {
            ...
            return lf.ActiveSkinName == "VS2010" ? ColorHelper.GetControlColor(lf) : ColorHelper.TextColor;
        }
    }
    ...
    static class EditorHelpers {
        ...
        static SvgImageCollection CreatePersonPrefixImageCollection() {
            ...
            svgImageCollection.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.PersonPrefix." + "Doctor.svg"), typeof(EditorHelpers).Assembly));
            svgImageCollection.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.PersonPrefix." + "Mr.svg"), typeof(EditorHelpers).Assembly));
            svgImageCollection.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.PersonPrefix." + "Ms.svg"), typeof(EditorHelpers).Assembly));
            svgImageCollection.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.PersonPrefix." + "Miss.svg"), typeof(EditorHelpers).Assembly));
            svgImageCollection.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.PersonPrefix." + "Mrs.svg"), typeof(EditorHelpers).Assembly));
            return svgImageCollection;
        }
        static SvgImageCollection CreateTaskPrioritySvgImageCollection() {
            SvgImageCollection ret = new SvgImageCollection();
            ret.ImageSize = new Size(16, 16);
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.signal-bar-1-dx_desktop-regular-blue-16.svg"), typeof(MainForm).Assembly));
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.signal-bar-2-dx_desktop-regular-blue-16.svg"), typeof(MainForm).Assembly));
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.signal-bar-3-dx_desktop-regular-blue-16.svg"), typeof(MainForm).Assembly));
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.signal-bar-dx_desktop-regular-blue-16.svg"), typeof(MainForm).Assembly));
            return ret;
        }
        ...
        internal static object CreatePaymentStatusImageCollection(ISkinProvider provider) {
            SvgImageCollection ret = new SvgImageCollection();
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.Orders.Payment" + "Unpaid.svg"), typeof(EditorHelpers).Assembly));
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.Orders.Payment" + "Paid.svg"), typeof(EditorHelpers).Assembly));
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.Orders.Payment" + "Refund.svg"), typeof(EditorHelpers).Assembly));
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.Orders.Payment" + "Other.svg"), typeof(EditorHelpers).Assembly));
            return ret;
        }
        internal static object CreateShipmentStatusImageCollection(ISkinProvider provider) { 
            SvgImageCollection ret = new SvgImageCollection();
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.Orders.Shipment" + "Awaiting.svg"), typeof(EditorHelpers).Assembly));
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.Orders.Shipment" + "Transit.svg"), typeof(EditorHelpers).Assembly));
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("DevExpress.DevAV.Resources.Orders.Shipment" + "Received.svg"), typeof(EditorHelpers).Assembly));
            return ret;
        }
        public static RepositoryItemImageComboBox CreateManeuverImageComboBox(RepositoryItemImageComboBox edit = null, RepositoryItemCollection collection = null) {
            RepositoryItemImageComboBox ret = CreateEnumImageComboBox<DevExpress.XtraMap.AzureRouteGuidanceManeuver>(edit, collection);
            foreach(ImageComboBoxItem item in ret.Items) {
                switch((DevExpress.XtraMap.AzureRouteGuidanceManeuver)item.Value) {
                    case DevExpress.XtraMap.AzureRouteGuidanceManeuver.Depart:
                        item.ImageIndex = 0;
                        break;
                    case DevExpress.XtraMap.AzureRouteGuidanceManeuver.TurnLeft:
                        item.ImageIndex = 1;
                        break;
                    case DevExpress.XtraMap.AzureRouteGuidanceManeuver.TurnRight:
                        item.ImageIndex = 2;
                        break;
                    case DevExpress.XtraMap.AzureRouteGuidanceManeuver.Arrive:
                    case DevExpress.XtraMap.AzureRouteGuidanceManeuver.ArriveLeft:
                    case DevExpress.XtraMap.AzureRouteGuidanceManeuver.ArriveRight:
                        item.ImageIndex = 3;
                        break;
                    case DevExpress.XtraMap.AzureRouteGuidanceManeuver.MakeUTurn:
                        item.ImageIndex = 4;
                        break;
                    case DevExpress.XtraMap.AzureRouteGuidanceManeuver.BearLeft:
                        item.ImageIndex = 5;
                        break;
                    case DevExpress.XtraMap.AzureRouteGuidanceManeuver.BearRight:
                        item.ImageIndex = 6;
                        break;
                }
        ...
        static SvgImageCollection CreateAzureManeuverTypeSvgImageCollection() {
            SvgImageCollection ret = new SvgImageCollection();
            ret.ImageSize = new Size(32, 32);
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("icon_A_32"), typeof(MainForm).Assembly));
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("icon_arrow_left_32"), typeof(MainForm).Assembly));
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("icon_arrow_right_32"), typeof(MainForm).Assembly));
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("icon_B_32"), typeof(MainForm).Assembly));
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("icon_arrow_uturn_32"), typeof(MainForm).Assembly));
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("icon_arrow_bear_left_32"), typeof(MainForm).Assembly));
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("icon_arrow_bear_right_32"), typeof(MainForm).Assembly));
            ret.Add(SvgImage.FromResources(FluentIconHelper.GetFluentIconName("icon_arrow_forward_32"), typeof(MainForm).Assembly));
            return ret;
        }
        static ImageCollection CreateAzureManeuverTypeImageCollection() {
            ImageCollection ret = new ImageCollection();
            ret.ImageSize = new Size(32, 32);
    ...
    public static class SVGHelper {
        ...
        public static Dictionary<EmployeeTaskPriority, SvgImage> CreateTaskPriorityImages(ISkinProvider skinProvider, string rootPath) {
            ...
            result.Add(EmployeeTaskPriority.Low, SvgImage.FromResources(FluentIconHelper.GetFluentIconName(String.Concat(rootPath, "PriorityLow.svg")), asm));
            result.Add(EmployeeTaskPriority.Normal, SvgImage.FromResources(FluentIconHelper.GetFluentIconName(String.Concat(rootPath, "PriorityNormal.svg")), asm));
            result.Add(EmployeeTaskPriority.High, SvgImage.FromResources(FluentIconHelper.GetFluentIconName(String.Concat(rootPath, "PriorityHigh.svg")), asm));
            result.Add(EmployeeTaskPriority.Urgent, SvgImage.FromResources(FluentIconHelper.GetFluentIconName(String.Concat(rootPath, "PriorityUrgent.svg")), asm));
            return result;
        }
    }
}
