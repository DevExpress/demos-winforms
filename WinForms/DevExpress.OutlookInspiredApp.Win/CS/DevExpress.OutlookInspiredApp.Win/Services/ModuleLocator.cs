namespace DevExpress.DevAV.Services {
    ...
    sealed class ModuleLocator : IModuleLocator {
        readonly IServiceContainer serviceContainer;
        readonly IDictionary<ModuleType, WeakReference> modulesCache;
        readonly IDictionary<ModuleType, IDictionary<long, WeakReference>> modulesIdentityCache;
        ...
        public object GetModule(ModuleType moduleType, long keyParameter) {
            if(moduleType == ModuleType.Unknown)
                return null;
            var activator = serviceContainer.GetService<IModuleActivator>();
            IDictionary<long, WeakReference> identityCache = null;
    ...
    sealed class ReportLocator : IReportLocator {
        readonly IServiceContainer serviceContainer;
        readonly IDictionary<object, WeakReference> reportsCache;
        ...
        public object GetReport(object reportKey) {
            if(object.ReferenceEquals(reportKey, null))
                return null;
            WeakReference reportReference = null;
