namespace DevExpress.ChatClient.ViewModels {
    ...
    public class MessagesViewModel : ChannelViewModel {
        ...
        protected void OnSelectedTextChanged() {
            this.RaiseCanExecuteChanged(x => x.CopySelectedText());
        }
        ...
        public void CopyMessage() {
            ...
            DevExpress.Data.Utils.SafeClipboardWin.Instance.SetText(message);
        }
        public bool CanCopyMessageText() {
            return (SelectedMessage != null) && !SelectedMessage.IsDeleted;
        }
        public void CopyMessageText() {
            DevExpress.Data.Utils.SafeClipboardWin.Instance.SetText(SelectedMessage.Text);
        }
        public bool CanCopySelectedText() {
            return !string.IsNullOrEmpty(SelectedText);
        }
        public void CopySelectedText() {
            DevExpress.Data.Utils.SafeClipboardWin.Instance.SetText(SelectedText);
        }
