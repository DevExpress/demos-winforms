...
namespace DevExpress.DevAV.Reports.Spreadsheet {
	public static class CellsHelper {
		...
		public static Dictionary<CustomEditorIds, CustomEditorInfo> CustomEditorsConfig {
			get { return customEditorsConfig; }
		}
		...
		public static CellValue GetOrderCellValue(CellsKind cell, List<OrderItem> orderItems, Worksheet invoice) {
			var range = CellsHelper.GetActualCellRange(CellsHelper.FindLeftCell(cell), orderItems.Count);
