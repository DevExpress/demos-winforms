...
namespace DevExpress.DevAV.Reports {
	public class CustomerSalesDetailReport : DevExpress.XtraReports.UI.XtraReport {
		...
		void CustomerSalesDetail_DataSourceDemanded(object sender, EventArgs e) {
		...
		void xrLabel11_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e) {
		...
		void xrTableCell50_SummaryRowChanged(object sender, EventArgs e) {
			...
			storeInfo.TotalSales += total;
		}
		void xrTableCell50_SummaryGetResult(object sender, SummaryGetResultEventArgs e) {
			if(storeSales.Count > 0)
				e.Result = storeSales.Values.Aggregate((x, y) => x.TotalSales > y.TotalSales ? x : y).City;
			else e.Result = " - ";
			e.Handled = true;
		}
		void xrTableCell50_SummaryReset(object sender, EventArgs e) {
			storeSales.Clear();
		}
