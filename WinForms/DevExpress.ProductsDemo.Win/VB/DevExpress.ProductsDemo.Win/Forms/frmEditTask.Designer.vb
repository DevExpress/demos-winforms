...
'ORIGINAL LINE: this.sePercentComplete.EditValueChanged += new System.EventHandler(this.sePercentComplete_EditValueChanged);
			...
			Me.ribbonControl1.QuickToolbarItemLinks.Add(Me.findItem1, "FD")
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.richEditControl1.SelectionChanged += new System.EventHandler(this.richEditControl1_SelectionChanged);
			' 
			...
			Me.icbPriority.Properties.SmallImages = Me.icEditorsSVG
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.icbStatus.SelectedIndexChanged += new System.EventHandler(this.icbStatus_SelectedIndexChanged);
			' 
			' deStartDate
			' 
			...
			Me.icbCategory.Properties.SmallImages = Me.icCategorySVG
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.sbOK.Click += new System.EventHandler(this.sbOK_Click);
			' 
			' teSubject
			' 
			...
			Me.emptySpaceItem2.Location = New System.Drawing.Point(0, 436)
			...
			Me.layoutControlItem2.Location = New System.Drawing.Point(554, 436)
			...
			Me.layoutControlItem1.Location = New System.Drawing.Point(466, 436)
