Namespace DevExpress.ProductsDemo.Win.Controls
	Partial Public Class HelpControl
		...
		Private Sub InitializeComponent()
			...
			galleryItem1.ImageOptions.SvgImage = My.Resources.Online_Help1
			galleryItem1.Tag = "LinkHelp"
			resources.ApplyResources(galleryItem2, "galleryItem2")
			galleryItem2.ImageOptions.SvgImage = My.Resources.Code_Central1
			galleryItem2.Tag = "LinkGetStarted"
			resources.ApplyResources(galleryItem3, "galleryItem3")
			galleryItem3.ImageOptions.SvgImage = My.Resources.Contact_Us1
