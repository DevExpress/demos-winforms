...
Namespace DevExpress.ProductsDemo.Win.Controls
	Partial Public Class PrintControl
		...
		Private Sub InitializeComponent()
			...
			Me.printButton.ImageOptions.SvgImage = My.Resources.Print1
			...
			Me.pageButtonEdit.Properties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() {
				New DevExpress.XtraEditors.Controls.EditorButton((CType(resources.GetObject("pageButtonEdit.Properties.Buttons"), DevExpress.XtraEditors.Controls.ButtonPredefines)), resources.GetString("pageButtonEdit.Properties.Buttons1"), (CInt(resources.GetObject("pageButtonEdit.Properties.Buttons2"))), (CBool(resources.GetObject("pageButtonEdit.Properties.Buttons3"))), (CBool(resources.GetObject("pageButtonEdit.Properties.Buttons4"))), (CBool(resources.GetObject("pageButtonEdit.Properties.Buttons5"))), editorButtonImageOptions1, New DevExpress.Utils.KeyShortcut(System.Windows.Forms.Keys.None), serializableAppearanceObject1, serializableAppearanceObject2, serializableAppearanceObject3, serializableAppearanceObject4, resources.GetString("pageButtonEdit.Properties.Buttons6"), (CObj(resources.GetObject("pageButtonEdit.Properties.Buttons7"))), (CType(resources.GetObject("pageButtonEdit.Properties.Buttons8"), DevExpress.Utils.SuperToolTip)), (CType(resources.GetObject("pageButtonEdit.Properties.Buttons9"), DevExpress.Utils.ToolTipAnchor))),
				New DevExpress.XtraEditors.Controls.EditorButton((CType(resources.GetObject("pageButtonEdit.Properties.Buttons10"), DevExpress.XtraEditors.Controls.ButtonPredefines)))
			})
...
'ORIGINAL LINE: this.pageButtonEdit.ButtonClick += new DevExpress.XtraEditors.Controls.ButtonPressedEventHandler(this.pageButtonEdit_ButtonClick);
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.pageButtonEdit.EditValueChanged += new System.EventHandler(this.pageButtonEdit_EditValueChanged);
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.pageButtonEdit.EditValueChanging += new DevExpress.XtraEditors.Controls.ChangingEventHandler(this.pageButtonEdit_EditValueChanging);
			' 
			' panel2
			' 
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.zoomTrackBarControl1.EditValueChanged += new System.EventHandler(this.zoomTrackBarControl1_EditValueChanged);
			' 
			' labelControl4
			' 
