Namespace DevExpress.ProductsDemo.Win.Modules
	Partial Public Class WordModule
		...
		Private Sub InitializeComponent()
			...
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(WordModule))
...
'ORIGINAL LINE: this.richEditControl.SelectionChanged += new System.EventHandler(this.richEditControl_SelectionChanged);
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.richEditControl.StartHeaderFooterEditing += new DevExpress.XtraRichEdit.HeaderFooterEditingEventHandler(this.richEditControl_StartHeaderFooterEditing);
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.richEditControl.FinishHeaderFooterEditing += new DevExpress.XtraRichEdit.HeaderFooterEditingEventHandler(this.richEditControl_FinishHeaderFooterEditing);
			' 
			' ribbonControl1
			' 
			...
			Me.gridControl1.Size = New System.Drawing.Size(166, 555)
...
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.view.FocusedRowChanged += new DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventHandler(this.view_FocusedRowChanged);
			' 
			' colFullName
			' 
