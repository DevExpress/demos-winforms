...
namespace DevExpress.ApplicationUI.Demos.VisualEffects {
    public partial class GuideFlyoutPanel : XtraEditors.XtraUserControl {
        ...
        void InitializeNavigator(int count) {
            for(int i = 0; i < count; i++) {
                this.navigator.Buttons.Add(
                    new DevExpress.XtraBars.Docking2010.WindowsUIButton("Button", GetResourceImage(), 0, DevExpress.XtraBars.Docking2010.ImageLocation.Default,
                    DevExpress.XtraBars.Docking2010.ButtonStyle.CheckButton, "", false, -1, true, null, true, i == curentLessonIdCore, true, null, null, 1, false, false));
            }
        }
