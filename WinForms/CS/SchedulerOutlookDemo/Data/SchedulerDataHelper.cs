...
namespace DevExpress.XtraScheduler.Demos.DemoData {
    public class SchedulerDataHelper {
        ...
        internal static void AttachYearView(SchedulerControl scheduler) {
            new SchedulerDataHelper().AttachToYearView(scheduler);
        }
        ...
        void AttachToYearView(SchedulerControl scheduler) {
            scheduler.Tag = this;
            ...
            try {
                ...
                EventGenerator.GenerateForYearView(this.events);
