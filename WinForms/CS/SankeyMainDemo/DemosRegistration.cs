    ...
    public class DemosInfo : ModulesInfo {
        public static void DoShowModule(string name, GroupControl group, RibbonMenuManager manager) {
            ...
            try {
                ...
                SankeyTutorialControl sankeyTutorial = tutorialBase as SankeyTutorialControl;
                if(sankeyTutorial != null)
                    manager.AllowExport(sankeyTutorial.SankeyDiagramControl);
            }
            catch { }
