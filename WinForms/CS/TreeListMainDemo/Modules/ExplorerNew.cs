...
namespace DevExpress.XtraTreeList.Demos {
    public partial class ExplorerNew : TutorialControl {
        ...
        protected override string[] WhatsThisCodeFileNames { get { return new string[] { "TreeListMainDemo\\Modules\\ExplorerNew" }; } }
        protected override string WhatsThisXMLFileName { get { return "ExplorerNew"; } }
        void CalcImageSize() {
        ...
        void OnBreadCrumbEventsCustomItemContents(object sender, XtraEditors.Behaviors.CustomItemContentsEventArgs e) {
        ...
        void OnMouseEnterButton(object sender, EventArgs e) {
            ...
            button.ButtonStyle = XtraEditors.Controls.BorderStyles.Default;
        }
        void OnMouseLeaveButton(object sender, EventArgs e) {
            SimpleButton button = (SimpleButton)sender;
            button.ButtonStyle = XtraEditors.Controls.BorderStyles.NoBorder;
        }
    }
    ...
    public class ThisPCItem : Item {
        ...
        public override List<Item> GetDirectories() {
            ...
            items.Add(new DirectoryItem(DevExpress.Data.Utils.SafeEnvironment.DesktopDirectory));
            items.Add(new DirectoryItem(DevExpress.Data.Utils.SafeEnvironment.MyDocuments));
            items.Add(new DirectoryItem(DevExpress.Data.Utils.SafeEnvironment.MyMusic));
            items.Add(new DirectoryItem(DevExpress.Data.Utils.SafeEnvironment.MyPictures));
            items.Add(new DirectoryItem(DevExpress.Data.Utils.SafeEnvironment.MyVideos));
        ...
        public override List<CustomFileInfo> GetFilesSystemInfo() {
            ...
            infos.Add(CreateSystemFolderInfo(new DirectoryInfo(DevExpress.Data.Utils.SafeEnvironment.DesktopDirectory)));
            infos.Add(CreateSystemFolderInfo(new DirectoryInfo(DevExpress.Data.Utils.SafeEnvironment.MyDocuments)));
            infos.Add(CreateSystemFolderInfo(new DirectoryInfo(DevExpress.Data.Utils.SafeEnvironment.MyMusic)));
            infos.Add(CreateSystemFolderInfo(new DirectoryInfo(DevExpress.Data.Utils.SafeEnvironment.MyPictures)));
            infos.Add(CreateSystemFolderInfo(new DirectoryInfo(DevExpress.Data.Utils.SafeEnvironment.MyVideos)));
            string[] drives = System.IO.Directory.GetLogicalDrives();
            foreach(string drive in drives) {
