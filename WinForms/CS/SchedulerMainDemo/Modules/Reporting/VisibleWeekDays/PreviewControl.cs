...
namespace DevExpress.XtraScheduler.Demos.Reporting.VisibleWeekDays {
    ...
    public class PreviewControl : ReportPreviewControlBase {
        ...
        WeekDays _visibleWeekDays = WeekDays.EveryDay;
        private MonthReport _monthReport;
        ...
        MonthReport MonthReport { get { return _monthReport; } }
        DayReport DayReport { get { return _dayReport; } }
        WeekDays VisibleWeekDays { get { return _visibleWeekDays; } set { _visibleWeekDays = value; } }
        ...
        protected override void CreateReports() {
            if (_monthReport != null)
                _monthReport.Dispose();
            this._monthReport = new MonthReport();
            if (_dayReport != null)
                _dayReport.Dispose();
            this._dayReport = new DayReport();
        }
		...
		protected override void UpdateReportProperties(XtraSchedulerReport otherReport) {
            ...
            if (ViewType.Equals(SchedulerViewType.Month))
                ...
                DayReport dailyReport = (DayReport)otherReport;
                dailyReport.VisibleWeekDays = this.VisibleWeekDays;
