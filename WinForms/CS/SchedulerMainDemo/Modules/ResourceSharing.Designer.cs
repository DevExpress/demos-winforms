...
namespace DevExpress.XtraScheduler.Demos {
	partial class ResourceSharingModule {
		...
		private void InitializeComponent() {
            ...
            // schedulerStorage
            // 
            this.schedulerDataStorage.Appointments.ResourceSharing = true;
            this.schedulerDataStorage.AppointmentInserting += new DevExpress.XtraScheduler.PersistentObjectCancelEventHandler(this.schedulerStorage_AppointmentChanging);
            this.schedulerDataStorage.AppointmentChanging += new DevExpress.XtraScheduler.PersistentObjectCancelEventHandler(this.schedulerStorage_AppointmentChanging);
            // 
            // splitterControl1
            // 
