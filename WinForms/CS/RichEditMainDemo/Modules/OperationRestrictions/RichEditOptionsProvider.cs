...
namespace DevExpress.XtraRichEdit.Demos {
    public class RichEditOptionsProvider {
        readonly RichEditClipboardOptionsProvider _clipboardOptionsProvider;
        readonly RichEditCommonOptionsProvider _commonOptionsProvider;
        readonly RichEditZoomOptionsProvider _zoomOptionsProvider;
        readonly RichEditMiscellaneousOptionsProvider _miscellaneousOptionsProvider;
        readonly RichEditDocumentCapabilitiesOptionsProvider _documentCapabilitiesOptionsProvider;
    ...
    public class RichEditClipboardOptionsProvider {
        readonly RichEditBehaviorOptions _options;
    ...
    public class RichEditDocumentCapabilitiesOptionsProvider {
        readonly DocumentCapabilitiesOptions _options;
        readonly RichEditNumberingOptionsProvider _numberingOptionsProvider;
    ...
    public class RichEditNumberingOptionsProvider {
        readonly NumberingOptions _options;
