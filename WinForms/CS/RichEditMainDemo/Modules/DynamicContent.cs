...
namespace DevExpress.XtraRichEdit.Demos {
    public partial class DynamicContentModule : TutorialControl {
        public DynamicContentModule() {
            InitializeComponent();
            RibbonControl ribbonControl = richEditControl.CreateRibbon(RichEditToolbarType.File | RichEditToolbarType.Home | RichEditToolbarType.MailMerge);
        ...
        RichEditDocumentServer GenerateRssFeed() {
            ...
            try {
                using(XmlReader reader = SafeXml.CreateReader("https://community.devexpress.com/blogs/MainFeed.aspx"))
