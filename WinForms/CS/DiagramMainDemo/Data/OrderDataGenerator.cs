...
namespace DevExpress.Diagram.Demos {
    public static class OrderDataGenerator {
        ...
        static List<ProductData> ExtractProductDataList(List<CategoryData> categoriesList) {
            ...
            var rand = DevExpress.Data.Utils.NonCryptographicRandom.Default;
...
#pragma warning disable CS9236  // It makes no sense to fix it because it's just the generator for demo's data
