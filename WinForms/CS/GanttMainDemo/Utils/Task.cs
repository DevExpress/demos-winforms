...
namespace DevExpress.XtraGantt.Demos {
    public class TaskDataItem {
        ...
        public TaskDataItem(string uid, string parentUID, string name, string startDate, string duration, string finishDate, string baselineStartDate, string baselineFinishDate, 
            double progress, List<string> predecessors, string resources, bool visibleInTimeline) {
            UID = uid;
            ParentUID = parentUID;
            Name = name;
