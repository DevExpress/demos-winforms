...
using eEntityState = Microsoft.EntityFrameworkCore.EntityState;
#else
using System.Data.Entity;
using System.Data.Entity.Infrastructure;
using System.Data.Entity.Validation;
using eEntityState = System.Data.Entity.EntityState;
#endif
...
namespace DevExpress.MVVM.Demos.Common.DataModel.EntityFramework {
    ...
    public class DbRepository<TEntity, TPrimaryKey, TDbContext> : DbReadOnlyRepository<TEntity, TDbContext>, IRepository<TEntity, TPrimaryKey>
...
#if NET
            TEntity newEntity = DbSet.CreateProxy<TEntity>();
#else
        ...
        static EntityState GetEntityState(eEntityState entityStates) {
            switch(entityStates) {
