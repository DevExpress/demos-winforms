                ...
                try {
                    ...
                    for (global::System.Collections.IEnumerator schemas = xs.Schemas(dsSchema.TargetNamespace).GetEnumerator(); schemas.MoveNext(); ) {
                        ...
                        if ((s1.Length == s2.Length)) {
                            s1.Position = 0;
                            s2.Position = 0;
                            for (; ((!s1.Position.Equals(s1.Length)) 
                                        && (s1.ReadByte() == s2.ReadByte())); ) {
                                ;
                            }
                            if ((s1.Position.Equals(s1.Length))) {
                                return type;
                            }
                        }
                    }
...
namespace DevExpress.XtraCharts.Demos.DS5TableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\Work\\2010.1\\Demos.Win\\ChartsDemos" +
                "\\Data\\nwind.mdb";
        }
