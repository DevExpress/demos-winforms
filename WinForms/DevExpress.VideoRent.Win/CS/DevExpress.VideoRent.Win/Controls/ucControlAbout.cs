...
namespace DevExpress.VideoRent.Win.Controls {
    public partial class ucControlAbout : XtraUserControl, IXtraResizableControl {
        static int LinkHeight = ScaleUtils.ScaleContentWithTouchScale(45);
        ...
        public void Init(string name, DemoProducts product, Image image) {
            ...
            peAbout.Image = image;
            if(image != null)
                peAbout.Height = ScaleHelper.ScaleVertical(image.Height);
            RaiseChanged();
        ...
        Size GetAppropriateSize() { return new Size(ControlWidth, ControlHeight); }
        int ControlWidth { get { return ScaleHelper.ScaleHorizontal(peAbout.Image == null ? 200 : peAbout.Image.Width + PictureIndent * 2); } }
