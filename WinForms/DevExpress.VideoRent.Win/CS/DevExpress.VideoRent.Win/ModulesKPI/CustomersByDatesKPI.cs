...
namespace DevExpress.VideoRent.Win.ModulesKPI {
    public partial class CustomersByDatesKPI : ChartExportTutorialControl {
        ...
        public CustomersByDatesKPI() {
            ...
            customersChart.Series[0].LegendTextPattern = EnumTitlesKeeper<CustomerDiscountLevel>.GetTitle(CustomerDiscountLevel.FirstTime);
            customersChart.Series[1].LegendTextPattern = EnumTitlesKeeper<CustomerDiscountLevel>.GetTitle(CustomerDiscountLevel.Basic);
            customersChart.Series[2].LegendTextPattern = EnumTitlesKeeper<CustomerDiscountLevel>.GetTitle(CustomerDiscountLevel.Occasional);
            customersChart.Series[3].LegendTextPattern = EnumTitlesKeeper<CustomerDiscountLevel>.GetTitle(CustomerDiscountLevel.Active);
            customersChart.Series[4].LegendTextPattern = EnumTitlesKeeper<CustomerDiscountLevel>.GetTitle(CustomerDiscountLevel.Prodigious);
