...
namespace DevExpress.VideoRent.Win.ModulesKPI {
    public partial class CustomersKPI : ChartExportTutorialControl {
        ...
        public CustomersKPI() {
            ...
            discountChart.Series[0].LegendTextPattern = EnumTitlesKeeper<CustomerDiscountLevel>.GetTitle(CustomerDiscountLevel.FirstTime);
            discountChart.Series[1].LegendTextPattern = EnumTitlesKeeper<CustomerDiscountLevel>.GetTitle(CustomerDiscountLevel.Basic);
            discountChart.Series[2].LegendTextPattern = EnumTitlesKeeper<CustomerDiscountLevel>.GetTitle(CustomerDiscountLevel.Occasional);
            discountChart.Series[3].LegendTextPattern = EnumTitlesKeeper<CustomerDiscountLevel>.GetTitle(CustomerDiscountLevel.Active);
            discountChart.Series[4].LegendTextPattern = EnumTitlesKeeper<CustomerDiscountLevel>.GetTitle(CustomerDiscountLevel.Prodigious);
        ...
        void DiscountKPI_Load(object sender, EventArgs e) {
            ...
            discountOverTimeGrid.BeginUpdate();
            ...
            discountOverTimeGrid.EndUpdate();
        ...
        void BindSeries(PivotGridControl pivotGrid, CustomerDiscountLevel level) {
            ...
            series.FilterCriteria = new BinaryOperator("Values", (decimal)level, BinaryOperatorType.Equal);
            series.DateTimeSummaryOptions.SummaryFunction = "COUNTWITHZEROS()";
        }
