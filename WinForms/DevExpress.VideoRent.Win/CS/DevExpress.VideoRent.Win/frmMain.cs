...
namespace DevExpress.VideoRent.Win {
    public partial class frmMain : frmMainBase, IFormWithLayoutManager {
        ...
        static BarButtonItem CreateDesignerButton() {
            ...
            buttonItem.ImageOptions.Image = ResourceImageHelper.CreateImageFromResources("DevExpress.VideoRent.Resources.Images.Action_Report_ShowDesigner.png", typeof(DevExpress.VideoRent.Resources.ImagesHelper).Assembly);
            buttonItem.ImageOptions.LargeImage = ResourceImageHelper.CreateImageFromResources("DevExpress.VideoRent.Resources.Images.Action_Report_ShowDesigner_32x32.png", typeof(DevExpress.VideoRent.Resources.ImagesHelper).Assembly);
            buttonItem.ImageOptions.ImageUri.ResourceType = typeof(DevExpress.VideoRent.Resources.ImagesHelper);
            buttonItem.ImageOptions.ImageUri.Uri = "resource://DevExpress.VideoRent.Resources.Images.Designer.svg";
            return buttonItem;
        }
        #endregion
        ...
        protected override void ScaleControl(SizeF factor, BoundsSpecified specified) {
            ...
            if(pccBottomControlContainer != null)
                pccBottomControlContainer.Scale(factor);
        }
