...
namespace DevExpress.VideoRent.Win.Modules {
    public partial class MovieDetail : DetailBase {
        ...
        void gvArtist_ValidateRow(object sender, DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs e) {
            CheckDirectors();
        }
        ...
        void gvArtist_CustomDrawCell(object sender, DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventArgs e) {
        ...
        void teWebSite_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e) {
            ObjectHelper.ShowWebSite(teWebSite.Text);
        }
        void ucGridEditBarCompanies_AddRecord(object sender, EventArgs e) {
        ...
        void ucGridEditBarCompanies_DeleteRecord(object sender, EventArgs e) {
        ...
        void ucGridEditBarArtist_AddRecord(object sender, EventArgs e) {
        ...
        void ucGridEditBarArtist_DeleteRecord(object sender, EventArgs e) {
        ...
        void lueCategory_EditValueChanged(object sender, EventArgs e) {
            ucMovieFormatsInfo.Init((MovieCategory)lueCategory.EditValue, Movie.Items, lcMain.MenuManager);
        }
