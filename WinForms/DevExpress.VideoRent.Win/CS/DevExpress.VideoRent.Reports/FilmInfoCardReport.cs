...
namespace DevExpress.VideoRent.Reports {
    public partial class FilmInfoCardReport : ReportBase {
        ...
        protected override void OnParametersRequestSubmit(ParametersRequestEventArgs e) {
            ...
            ParameterInfo info = e.ParametersInformation.FirstOrDefault(x => x.Parameter.Name == filmListParameterName);
            var editor = info != null ? info.Editor as CheckedComboBoxEdit : null;
            if(editor != null && AreAllItemsChecked(editor)) {
        ...
        void xrBarCode2_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e) {
