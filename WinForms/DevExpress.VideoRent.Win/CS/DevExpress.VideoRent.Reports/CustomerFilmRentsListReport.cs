...
namespace DevExpress.VideoRent.Reports {
    ...
    public partial class CustomerFilmRentsListReport : CustomerSelectionReportBase {
        ...
        void xrPictureBoxCustomerPhoto_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e) {
            XRPictureBox photo = sender as XRPictureBox;
            if(photo.Image == null) {
                photo.Image = ReferenceImages.UnknownPerson;
            }
        }
        void xrPictureBoxPhoto_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e) {
            XRPictureBox photo = sender as XRPictureBox;
            if(photo.Image == null) {
                photo.Image = ReferenceImages.UnknownMovie;
            }
        }
        void xrTableCellReturnedOn_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e) {
