...
Namespace DevExpress.XtraGrid.Demos
    ...
    Public Partial Class InplaceEditors
        ...
        Protected Overrides ReadOnly Property WhatsThisCodeFileNames As String()
            Get
                Return New String() {"InplaceEditors"}
            End Get
        End Property

        Protected Overrides ReadOnly Property WhatsThisXMLFileName As String
            Get
                Return "InplaceEditors"
            End Get
        End Property
        ...
        '</gridControl1>
        '<gridControl1>
        Private Sub gridView1_CustomRowCellEdit(ByVal sender As Object, ByVal e As Views.Grid.CustomRowCellEditEventArgs)
        ...
        Private Sub gridView1Popup_DoubleClick(ByVal sender As Object, ByVal e As EventArgs)
            Dim info As Views.Grid.ViewInfo.GridHitInfo = gridView1Popup.CalcHitInfo(gridPopup.PointToClient(MousePosition))
        ...
        Private Sub gridView1_FocusedRowChanged(ByVal sender As Object, ByVal e As Views.Base.FocusedRowChangedEventArgs)
            ...
            If item IsNot Nothing Then
                propertyGridPanel1.SelectedObject = item.RepositoryItem
