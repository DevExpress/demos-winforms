...
Namespace DevExpress.XtraPivotGrid.Demos
    ...
    Public Class DemosInfo
        ...
        Public Shared Sub Show(ByVal name As String, ByVal group As XtraEditors.GroupControl, ByVal description As Control, ByVal manager As PivotGridRibbonMenuManager)
