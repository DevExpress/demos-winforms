...
#Region "Component Designer generated code"
        ...
        Private Overloads Sub InitializeComponent()
            ...
            Dim customLegendItem6 As DevExpress.XtraCharts.CustomLegendItem = New DevExpress.XtraCharts.CustomLegendItem()
            ...
            Dim dataSourceAdapter7 As DevExpress.XtraCharts.DataSourceAdapter = New DevExpress.XtraCharts.DataSourceAdapter()
            ...
            Dim dataSourceAdapter8 As DevExpress.XtraCharts.DataSourceAdapter = New DevExpress.XtraCharts.DataSourceAdapter()
            ...
            Me.synchronousTimer = New System.Windows.Forms.Timer(Me.components)
            ...
            swiftPlotDiagram1.Panes.AddRange(New DevExpress.XtraCharts.XYDiagramPane() {xyDiagramPane1, xyDiagramPane2, xyDiagramPane3})
            ...
            swiftPlotDiagram1.SecondaryAxesY.AddRange(New DevExpress.XtraCharts.SwiftPlotDiagramSecondaryAxisY() {swiftPlotDiagramSecondaryAxisY1, swiftPlotDiagramSecondaryAxisY2, swiftPlotDiagramSecondaryAxisY3})
            ...
            dataSourceAdapter6.DataMembers.AddRange(New DevExpress.XtraCharts.DataMember() {dataMember11, dataMember12})
            ...
            dataSourceAdapter7.DataMembers.AddRange(New DevExpress.XtraCharts.DataMember() {dataMember13, dataMember14})
            ...
            dataSourceAdapter8.DataMembers.AddRange(New DevExpress.XtraCharts.DataMember() {dataMember15, dataMember16})
            ...
            Me.chart.SeriesSerializable = New DevExpress.XtraCharts.Series() {series1, series2, series3, series4, series5, series6, series7, series8}
            ...
            ' synchronousTimer
            ' 
            Me.synchronousTimer.Interval = 15
            AddHandler Me.synchronousTimer.Tick, New System.EventHandler(AddressOf Me.synchronousTimer_Tick)
            ' 
            ' RealTimeChartDemo
            ' 
            ...
            Me.Size = New System.Drawing.Size(999, 644)
...
#End Region
        ...
        Private synchronousTimer As System.Windows.Forms.Timer
    End Class
End Namespace
