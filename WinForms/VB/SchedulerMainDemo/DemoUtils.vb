...
Namespace DevExpress.XtraScheduler.Demos
    ...
    Public Class DemoUtils
        ...
        Private Shared Function GetResourceStream(ByVal resourceName As String) As Stream
            Dim result As Stream = Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream(resourceName)
        ...
        Public Shared Function GenerateScheduleTasks() As DataTable
            ...
            For i As Integer = 0 To 21 - 1
                ...
                tbl.Rows.Add(New Object() {i + 1, subject, TutorialConstants.Random.Next(3), TutorialConstants.Random.Next(3), Math.Max(1, TutorialConstants.Random.Next(8)), description})
            Next
    ...
    Public Class SchedulerDemoLogify
        ...
        Public Shared Sub Register()
            Call LogifyState.Instance.AddCustomDataProvider(New SchedulerDemoLogify())
        End Sub
        ...
        Public Sub CollectCustomData(ByVal data As IDictionary(Of String, String))
            Dim dpi As Size = ScaleUtils.GetSystemDPI()
            data.Add("dpi", String.Format("{0} : {1}", dpi.Width, dpi.Height))
            data.Add("skin name", String.Format("{0}", LookAndFeel.UserLookAndFeel.Default.ActiveSkinName))
