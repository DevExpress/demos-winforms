...
Namespace DevExpress.XtraScheduler.Demos
    ...
    Public Partial Class WeekViewModule
        ...
        Private Sub WeekViewModule_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Private Sub WeekViewModule_VisibleChanged(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Private Sub chkStatusOrientation_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs)
            Dim weekViewOptions As WeekViewAppointmentDisplayOptionsEx = TryCast(DisplayOptions, WeekViewAppointmentDisplayOptionsEx)
            If weekViewOptions IsNot Nothing Then weekViewOptions.ShowAppointmentStatusVertically = chkStatusOrientation.Checked
        End Sub
    End Class
End Namespace
