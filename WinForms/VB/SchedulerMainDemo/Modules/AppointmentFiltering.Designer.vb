...
#Region "Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            ' schedulerStorage
            '                
            AddHandler Me.schedulerStorage.FilterAppointment, New DevExpress.XtraScheduler.PersistentObjectCancelEventHandler(AddressOf Me.schedulerStorage_FilterAppointment)
            ' 
            ' panelControl
            ' 
            ...
            AddHandler Me.imcbSports.SelectedIndexChanged, New System.EventHandler(AddressOf Me.imcbSports_SelectedIndexChanged)
            ' 
            ' lblResource
            ' 
            ...
            ' schedulerStorage
            ' 
            Me.schedulerStorage.Appointments.Labels.Add("0", "Basketball", "&Basketball", System.Drawing.SystemColors.Window)
            Me.schedulerStorage.Appointments.Labels.Add("1", "Boxing", "&Boxing", System.Drawing.Color.FromArgb(255, 194, 190))
            Me.schedulerStorage.Appointments.Labels.Add("2", "Tennis", "&Tennis", System.Drawing.Color.FromArgb(168, 213, 255))
            Me.schedulerStorage.Appointments.Labels.Add("3", "Weightlifting", "&Weightlifting", System.Drawing.Color.FromArgb(193, 244, 156))
            Me.schedulerStorage.Appointments.Labels.Add("4", "Fencing", "&Fencing", System.Drawing.Color.FromArgb(243, 228, 199))
            Me.schedulerStorage.Appointments.Labels.Add("5", "Soccer", "&Soccer", System.Drawing.Color.FromArgb(244, 206, 147))
            Me.schedulerStorage.Appointments.Labels.Add("6", "Artistic Gymnastics", "&Artistic Gymnastics", System.Drawing.Color.FromArgb(199, 244, 255))
            Me.schedulerStorage.Appointments.Labels.Add("7", "Canoe", "&Canoe", System.Drawing.Color.FromArgb(207, 219, 152))
            Me.schedulerStorage.Appointments.Labels.Add("8", "Kayak", "&Kayak", System.Drawing.Color.FromArgb(224, 207, 233))
            Me.schedulerStorage.Appointments.Labels.Add("9", "Wrestling", "&Wrestling", System.Drawing.Color.FromArgb(141, 233, 223))
            Me.schedulerStorage.Appointments.Labels.Add("10", "Equestrianism", "&Equestrianism", System.Drawing.Color.FromArgb(255, 247, 165))
            Me.schedulerStorage.Appointments.Labels.Add("11", "Sailing", "&Sailing", System.Drawing.Color.FromArgb(225, 164, 160))
            Me.schedulerStorage.Appointments.Labels.Add("12", "Swimming", "S&wimming", System.Drawing.Color.FromArgb(138, 183, 225))
            Me.schedulerStorage.Appointments.Labels.Add("13", "Diving", "&Diving", System.Drawing.Color.FromArgb(163, 214, 126))
            Me.schedulerStorage.Appointments.Labels.Add("14", "Handball", "&Handball", System.Drawing.Color.FromArgb(213, 198, 169))
            Me.schedulerStorage.Appointments.Labels.Add("15", "Gymnastics", "&Gymnastics", System.Drawing.Color.FromArgb(214, 176, 117))
            Me.schedulerStorage.Appointments.Labels.Add("16", "Athletics", "&Athletics", System.Drawing.Color.FromArgb(169, 214, 225))
            Me.schedulerStorage.Appointments.Labels.Add("17", "Shooting", "Shoo&tin", System.Drawing.Color.FromArgb(177, 189, 122))
            Me.schedulerStorage.Appointments.Labels.Add("18", "Archery", "Arche&ry", System.Drawing.Color.FromArgb(194, 177, 213))
            Me.schedulerStorage.Appointments.Labels.Add("19", "Cycling", "C&ycling", System.Drawing.Color.FromArgb(111, 203, 193))
            Me.schedulerStorage.Appointments.Labels.Add("20", "Water Polo", "Water &Polo", System.Drawing.Color.FromArgb(225, 217, 135))
            Me.schedulerStorage.Appointments.Labels.Add("21", "Volleyball", "&Volleyball", System.Drawing.Color.FromArgb(195, 134, 130))
            Me.schedulerStorage.Appointments.Statuses.Add(DevExpress.XtraScheduler.AppointmentStatusType.Busy, "Busy", "&Busy", New System.Drawing.SolidBrush(System.Drawing.Color.FromArgb(74, 135, 226)))
            ' 
            ' splitterControl1
            ' 
            ...
            AddHandler Me.Load, New System.EventHandler(AddressOf Me.ResourceSharingModule_Load)
...
#End Region
        ...
        Private imcbSports As DevExpress.XtraEditors.ImageComboBoxEdit
