...
#Region "Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Dim timeRuler11 As DevExpress.XtraScheduler.TimeRuler = New DevExpress.XtraScheduler.TimeRuler()
            Dim timeRuler12 As DevExpress.XtraScheduler.TimeRuler = New DevExpress.XtraScheduler.TimeRuler()
            ...
            Me.schedulerControl.Location = New System.Drawing.Point(0, 189)
            Me.schedulerControl.MenuManager = Me.ribbonControl1
            Me.schedulerControl.Name = "schedulerControl"
            Me.schedulerControl.Size = New System.Drawing.Size(704, 215)
            ...
            Me.schedulerControl.Views.DayView.TimeRulers.Add(timeRuler10)
            Me.schedulerControl.Views.FullWeekView.Enabled = True
            Me.schedulerControl.Views.FullWeekView.TimeRulers.Add(timeRuler11)
            ...
            Me.schedulerControl.Views.WorkWeekView.TimeRulers.Add(timeRuler12)
            ' 
            ' schedulerStorage
            ' 
            Me.schedulerDataStorage.RemindersCheckInterval = 5000
            ' 
            ' ribbonControl1
            ' 
            ...
            ' 
            Me.btnCreateAppointmentWithReminder.ImageOptions.ImageIndex = 2
            Me.btnCreateAppointmentWithReminder.Location = New System.Drawing.Point(11, 9)
            ...
            AddHandler Me.btnCreateAppointmentWithReminder.Click, New System.EventHandler(AddressOf Me.btnCreateAppointmentWithReminder_Click)
            ' 
            ...
            AddHandler Me.VisibleChanged, New System.EventHandler(AddressOf Me.RemindersModule_VisibleChanged)
...
#End Region
        ...
        Private btnCreateAppointmentWithReminder As DevExpress.XtraEditors.SimpleButton
