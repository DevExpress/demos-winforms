...
#Region "Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.schedulerControl.Location = New System.Drawing.Point(0, 214)
            Me.schedulerControl.MenuManager = Me.ribbonControl1
            Me.schedulerControl.Name = "schedulerControl"
            Me.schedulerControl.Size = New System.Drawing.Size(1039, 190)
            ...
            Me.schedulerControl.Views.DayView.AppointmentDisplayOptions.StatusDisplayType = DevExpress.XtraScheduler.AppointmentStatusDisplayType.Bounds
            Me.schedulerControl.Views.DayView.DayCount = 3
            Me.schedulerControl.Views.DayView.TimeRulers.Add(timeRuler9)
            Me.schedulerControl.Views.FullWeekView.AppointmentDisplayOptions.StatusDisplayType = DevExpress.XtraScheduler.AppointmentStatusDisplayType.Bounds
            ...
            Me.schedulerControl.Views.WorkWeekView.AppointmentDisplayOptions.StatusDisplayType = DevExpress.XtraScheduler.AppointmentStatusDisplayType.Bounds
            Me.schedulerControl.Views.WorkWeekView.Enabled = False
            Me.schedulerControl.Views.WorkWeekView.TimeRulers.Add(timeRuler10)
            ' 
            ' schedulerStorage
            ' 
            Me.schedulerDataStorage.Appointments.Mappings.AppointmentId = "Id"
            Me.schedulerDataStorage.Appointments.Mappings.[End] = "EndTime"
            Me.schedulerDataStorage.Appointments.Mappings.Label = "Label"
            Me.schedulerDataStorage.Appointments.Mappings.ResourceId = "ResourceId"
            Me.schedulerDataStorage.Appointments.Mappings.Start = "StartTime"
            Me.schedulerDataStorage.Appointments.Mappings.Subject = "Subject"
            ' 
            ' ribbonControl1
            ' 
            ...
            Me.panelControl.Size = New System.Drawing.Size(1039, 65)
            ...
            Me.grControl.Size = New System.Drawing.Size(240, 53)
            Me.grControl.Dock = System.Windows.Forms.DockStyle.Left
            ...
            Me.grSwitch.Properties.Appearance.BackColor = System.Drawing.Color.Transparent
            Me.grSwitch.Properties.Appearance.Options.UseBackColor = True
            Me.grSwitch.Properties.BorderStyle = DevExpress.XtraEditors.Controls.BorderStyles.NoBorder
            ...
            Me.grSwitch.Dock = System.Windows.Forms.DockStyle.Fill
            Me.grSwitch.TabIndex = 84
            AddHandler Me.grSwitch.SelectedIndexChanged, New System.EventHandler(AddressOf Me.grSwitch_SelectedIndexChanged)
            ' 
            ...
            Me.panelSeparatorControl.Location = New System.Drawing.Point(0, 206)
            ...
            AddHandler Me.Load, New System.EventHandler(AddressOf Me.PerformanceTestModule_Load)
            AddHandler Me.VisibleChanged, New System.EventHandler(AddressOf Me.PerformanceTestModule_VisibleChanged)
...
#End Region
        ...
        Private grControl As DevExpress.XtraEditors.GroupControl

        Private grSwitch As DevExpress.XtraEditors.RadioGroup

        Private tasksTableAdapter1 As DevExpress.XtraScheduler.Demos.TasksDataSetTableAdapters.TasksTableAdapter

        Private tasksDataSet1 As DevExpress.XtraScheduler.Demos.TasksDataSet
