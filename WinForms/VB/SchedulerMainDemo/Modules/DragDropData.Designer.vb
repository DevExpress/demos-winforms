...
#Region "Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            ' schedulerStorage
            ' 
            Me.schedulerStorage.Appointments.Labels.Add(System.Drawing.Color.FromArgb((CInt(((CByte((128)))))), (CInt(((CByte((255)))))), (CInt(((CByte((128))))))), "Minor", "&Minor")
            Me.schedulerStorage.Appointments.Labels.Add(System.Drawing.Color.FromArgb((CInt(((CByte((255)))))), (CInt(((CByte((192)))))), (CInt(((CByte((128))))))), "Moderate", "&Moderate")
            Me.schedulerStorage.Appointments.Labels.Add(System.Drawing.Color.FromArgb((CInt(((CByte((255)))))), (CInt(((CByte((128)))))), (CInt(((CByte((128))))))), "Severe", "&Severe")
            Me.schedulerStorage.Appointments.Statuses.Add(DevExpress.XtraScheduler.AppointmentStatusType.Free, "Low", "&Low", System.Drawing.Color.FromArgb((CInt(((CByte((128)))))), (CInt(((CByte((255)))))), (CInt(((CByte((128))))))))
            Me.schedulerStorage.Appointments.Statuses.Add(DevExpress.XtraScheduler.AppointmentStatusType.Tentative, "Normal", "&Normal", System.Drawing.Color.FromArgb((CInt(((CByte((255)))))), (CInt(((CByte((192)))))), (CInt(((CByte((128))))))))
            Me.schedulerStorage.Appointments.Statuses.Add(DevExpress.XtraScheduler.AppointmentStatusType.OutOfOffice, "High", "&High", System.Drawing.Color.FromArgb((CInt(((CByte((255)))))), (CInt(((CByte((128)))))), (CInt(((CByte((128))))))))
            ' 
            ' ribbonControl1
            ' 
            ...
            AddHandler Me.gridView1.MouseDown, New System.Windows.Forms.MouseEventHandler(AddressOf Me.grdTasks_MouseDown)
            AddHandler Me.gridView1.MouseMove, New System.Windows.Forms.MouseEventHandler(AddressOf Me.grdTasks_MouseMove)
            ' 
            ' colSubject
            ' 
            ...
            AddHandler Me.Load, New System.EventHandler(AddressOf Me.DragDropDataModule_Load)
            AddHandler Me.Resize, New System.EventHandler(AddressOf Me.DragDropDataModule_Resize)
