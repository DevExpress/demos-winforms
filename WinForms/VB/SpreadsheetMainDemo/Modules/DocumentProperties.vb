...
Namespace DevExpress.XtraSpreadsheet.Demos
    ...
    Public Partial Class DocumentPropertiesModule
        ...
        Public Sub New()
            ...
            spreadsheetControl1.Document.Unit = Office.DocumentUnit.Point
        ...
        Private Sub Cleanup(ByVal worksheet As Worksheet, ByVal rowIndex As Integer)
            ...
            If usedRange.BottomRowIndex >= rowIndex Then
                Dim range As CellRange = worksheet.Range.FromLTRB(1, rowIndex, 2, usedRange.BottomRowIndex)
                range.ClearContents()
                range.ClearFormats()
        ...
        Private Sub SetLastRowBorder(ByVal worksheet As Worksheet, ByVal rowIndex As Integer)
            Dim range As CellRange = worksheet.Range.FromLTRB(1, rowIndex - 1, 2, rowIndex - 1)
