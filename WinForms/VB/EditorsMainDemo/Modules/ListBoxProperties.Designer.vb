...
#Region "Designer generated code"
        ...
        Private Sub InitializeComponent()
            ...
            Me.groupControlTemplated = New DevExpress.XtraEditors.GroupControl()
            Me.ceShowContextButtons = New DevExpress.XtraEditors.CheckEdit()
            ...
            CType((Me.groupControlTemplated), System.ComponentModel.ISupportInitialize).BeginInit()
            Me.groupControlTemplated.SuspendLayout()
            CType((Me.ceShowContextButtons.Properties), System.ComponentModel.ISupportInitialize).BeginInit()
            Me.SuspendLayout()
            ' 
            ' groupControl1
            ' 
            Me.groupControl1.Controls.Add(Me.ceAutoHeight)
            ...
            Me.groupControl1.Size = New System.Drawing.Size(293, 313)
            Me.groupControl1.TabIndex = 17
            Me.groupControl1.Text = "ListBox properties"
            ' 
            ' ceAutoHeight
            ' 
            Me.ceAutoHeight.Location = New System.Drawing.Point(18, 279)
            Me.ceAutoHeight.Name = "ceAutoHeight"
            Me.ceAutoHeight.Properties.Caption = "Item auto-height"
            Me.ceAutoHeight.Size = New System.Drawing.Size(148, 20)
            Me.ceAutoHeight.TabIndex = 23
            AddHandler Me.ceAutoHeight.CheckedChanged, New System.EventHandler(AddressOf Me.ceAutoHeight_CheckedChanged)
            ' 
            ' ceTurnSearch
            ' 
            Me.ceTurnSearch.Location = New System.Drawing.Point(18, 254)
            Me.ceTurnSearch.Name = "ceTurnSearch"
            Me.ceTurnSearch.Properties.Caption = "Show search box"
            Me.ceTurnSearch.Size = New System.Drawing.Size(148, 20)
            Me.ceTurnSearch.TabIndex = 22
            AddHandler Me.ceTurnSearch.CheckedChanged, New System.EventHandler(AddressOf Me.ceTurnSearch_CheckedChanged)
            ' 
            ' ceIncrementalSearch
            ' 
            ...
            Me.ceIncrementalSearch.Size = New System.Drawing.Size(148, 20)
            Me.ceIncrementalSearch.TabIndex = 5
            AddHandler Me.ceIncrementalSearch.CheckedChanged, New System.EventHandler(AddressOf Me.ceIncrementalSearch_CheckedChanged)
            ' 
            ...
            AddHandler Me.icbHotTrackSelectMode.SelectedIndexChanged, New System.EventHandler(AddressOf Me.icbHotTrackSelectMode_SelectedIndexChanged)
            ' 
            ' labelControl2
            ' 
            ...
            AddHandler Me.icbHighlightedItemStyle.SelectedIndexChanged, New System.EventHandler(AddressOf Me.icbHighlightedItemStyle_SelectedIndexChanged)
            ' 
            ' labelControl1
            ' 
            ...
            Me.ceMultiColumn.Size = New System.Drawing.Size(148, 20)
            Me.ceMultiColumn.TabIndex = 7
            AddHandler Me.ceMultiColumn.CheckedChanged, New System.EventHandler(AddressOf Me.ceMultiColumn_CheckedChanged)
            ' 
            ' icbSortOrder
            ' 
            ...
            AddHandler Me.icbSortOrder.SelectedIndexChanged, New System.EventHandler(AddressOf Me.icbSortOrder_SelectedIndexChanged)
            ' 
            ' icbSelectionMode
            ' 
            ...
            AddHandler Me.icbSelectionMode.SelectedIndexChanged, New System.EventHandler(AddressOf Me.icbSelectionMode_SelectedIndexChanged)
            ' 
            ' seColumnWidth
            ' 
            ...
            AddHandler Me.seColumnWidth.EditValueChanged, New System.EventHandler(AddressOf Me.seColumnWidth_EditValueChanged)
            ' 
            ' label4
            ' 
            ...
            Me.ceHotTrack.Size = New System.Drawing.Size(148, 20)
            ...
            Me.groupControlChecked.Location = New System.Drawing.Point(30, 358)
            ...
            Me.ceCheckOnClick.Size = New System.Drawing.Size(148, 20)
            Me.ceCheckOnClick.TabIndex = 4
            AddHandler Me.ceCheckOnClick.CheckedChanged, New System.EventHandler(AddressOf Me.ceCheckOnClick_CheckedChanged)
            ' 
            ' groupControlImage
            ' 
            Me.groupControlImage.Controls.Add(Me.icbAlignment)
            Me.groupControlImage.Controls.Add(Me.label1)
            Me.groupControlImage.Location = New System.Drawing.Point(30, 358)
            ...
            Me.groupControlSearch.Location = New System.Drawing.Point(30, 358)
            ...
            AddHandler Me.cbShowDefaultButtonsMode.SelectedIndexChanged, New System.EventHandler(AddressOf Me.cbShowDefaultButtonsMode_SelectedIndexChanged)
            ' 
            ...
            AddHandler Me.tbFindDelay.EditValueChanged, New System.EventHandler(AddressOf Me.tbFindDelay_EditValueChanged)
            ' 
            ' lbFilterCondition
            ' 
            ...
            AddHandler Me.cbFilterCondition.SelectedIndexChanged, New System.EventHandler(AddressOf Me.cbFilterCondition_SelectedIndexChanged)
            ' 
            ' lbFindDelay
            ' 
            ...
            Me.ceShowMRUButton.Size = New System.Drawing.Size(122, 20)
            Me.ceShowMRUButton.TabIndex = 4
            AddHandler Me.ceShowMRUButton.CheckedChanged, New System.EventHandler(AddressOf Me.ceShowMRUButton_CheckedChanged)
            ' 
            ' ceShowClearButton
            ' 
            ...
            Me.ceShowClearButton.Size = New System.Drawing.Size(122, 20)
            Me.ceShowClearButton.TabIndex = 3
            AddHandler Me.ceShowClearButton.CheckedChanged, New System.EventHandler(AddressOf Me.ceShowClearButton_CheckedChanged)
            ' 
            ' ceShowSearchButton
            ' 
            ...
            Me.ceShowSearchButton.Size = New System.Drawing.Size(122, 20)
            Me.ceShowSearchButton.TabIndex = 2
            AddHandler Me.ceShowSearchButton.CheckedChanged, New System.EventHandler(AddressOf Me.ceShowSearchButton_CheckedChanged)
            ' 
            ' ceAllowAutoApply
            ' 
            ...
            Me.ceAllowAutoApply.Size = New System.Drawing.Size(110, 20)
            Me.ceAllowAutoApply.TabIndex = 1
            AddHandler Me.ceAllowAutoApply.CheckedChanged, New System.EventHandler(AddressOf Me.ceAllowAutoApply_CheckedChanged)
            ' 
            ' groupControlTemplated
            ' 
            Me.groupControlTemplated.Controls.Add(Me.ceShowContextButtons)
            Me.groupControlTemplated.Location = New System.Drawing.Point(30, 358)
            Me.groupControlTemplated.Name = "groupControlTemplated"
            Me.groupControlTemplated.Size = New System.Drawing.Size(293, 65)
            Me.groupControlTemplated.TabIndex = 22
            Me.groupControlTemplated.Text = "Context Buttons properties"
            ' 
            ' ceShowContextButtons
            ' 
            Me.ceShowContextButtons.Location = New System.Drawing.Point(18, 30)
            Me.ceShowContextButtons.Name = "ceShowContextButtons"
            Me.ceShowContextButtons.Properties.Caption = "Show context buttons"
            Me.ceShowContextButtons.Size = New System.Drawing.Size(148, 20)
            Me.ceShowContextButtons.TabIndex = 4
            AddHandler Me.ceShowContextButtons.CheckedChanged, New System.EventHandler(AddressOf Me.ceShowContextButtons_CheckedChanged)
            ' 
            ' ListBoxProperties
            ' 
            Me.AutoScaleDimensions = New System.Drawing.SizeF(6F, 13F)
            Me.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font
            Me.Controls.Add(Me.groupControlTemplated)
            ...
            CType((Me.groupControlTemplated), System.ComponentModel.ISupportInitialize).EndInit()
            Me.groupControlTemplated.ResumeLayout(False)
            CType((Me.ceShowContextButtons.Properties), System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
        ...
        Private icbSortOrder As DevExpress.XtraEditors.ImageComboBoxEdit

        Private icbSelectionMode As DevExpress.XtraEditors.ImageComboBoxEdit

        Private seColumnWidth As DevExpress.XtraEditors.SpinEdit

        Private ceMultiColumn As DevExpress.XtraEditors.CheckEdit
        ...
        Private ceCheckOnClick As DevExpress.XtraEditors.CheckEdit

        Private icbHotTrackSelectMode As DevExpress.XtraEditors.ImageComboBoxEdit

        Private labelControl2 As DevExpress.XtraEditors.LabelControl

        Private icbHighlightedItemStyle As DevExpress.XtraEditors.ImageComboBoxEdit

        Private labelControl1 As DevExpress.XtraEditors.LabelControl

        Private ceIncrementalSearch As DevExpress.XtraEditors.CheckEdit
        ...
        Private cbFilterCondition As DevExpress.XtraEditors.ImageComboBoxEdit

        Private lbFindDelay As DevExpress.XtraEditors.LabelControl

        Private ceShowMRUButton As DevExpress.XtraEditors.CheckEdit

        Private ceShowClearButton As DevExpress.XtraEditors.CheckEdit

        Private ceShowSearchButton As DevExpress.XtraEditors.CheckEdit

        Private ceAllowAutoApply As DevExpress.XtraEditors.CheckEdit

        Private tbFindDelay As DevExpress.XtraEditors.TrackBarControl

        Private ceTurnSearch As DevExpress.XtraEditors.CheckEdit

        Private cbShowDefaultButtonsMode As DevExpress.XtraEditors.ImageComboBoxEdit

        Private lbShowDefaultButtonsMode As DevExpress.XtraEditors.LabelControl

        Private groupControlTemplated As DevExpress.XtraEditors.GroupControl

        Private ceShowContextButtons As DevExpress.XtraEditors.CheckEdit

        Private ceAutoHeight As DevExpress.XtraEditors.CheckEdit
    End Class
End Namespace
