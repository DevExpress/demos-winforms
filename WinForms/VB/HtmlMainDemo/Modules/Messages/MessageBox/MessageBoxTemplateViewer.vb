...
Namespace DevExpress.HTML.Demos
    ...
    Public Class MessageBoxTemplateViewer
        Inherits TemplateCodeViewer

        Private form As HtmlMessageBoxForm
        ...
        Public Sub Init(ByVal form As HtmlMessageBoxForm, ByVal templates As HtmlTemplateCollection)
            Me.form = form
