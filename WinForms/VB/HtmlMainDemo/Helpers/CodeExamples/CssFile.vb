...
Namespace DevExpress.HTML.Demos.CodeExamples
    ...
    Public Class CssFile
        ...
        Public Sub New(ByVal fileName As String, ByVal Optional allowModify As Boolean = True)
            MyBase.New(GetType(DevExpress.HTML.Demos.CodeExamples.CssFile).Assembly.FullName, DevExpress.HTML.Demos.CodeExamples.CssFile.GetResourceName(fileName))
            Me.allowModifyField = allowModify
            Me.Name = "[CSS]"
        End Sub

        Public Sub New(ParamArray fileNames As String())
            MyBase.New(GetType(DevExpress.HTML.Demos.CodeExamples.CssFile).Assembly.FullName, String.Empty)
            ...
            For Each item In fileNames
                res.Add(DevExpress.HTML.Demos.CodeExamples.CssFile.GetResourceName(item))
            Next
        ...
        Private Shared Function GetResourceName(ByVal fileName As String) As String
            Const resourcePath As String = "DevExpress.HTML.Demos.CodeExamples.css."
            If DevExpress.DXperience.Demos.DemoHelper.IsCSharp Then
                Return resourcePath & fileName & ".css"
            Else
                Return fileName.Split("."c).Last() & ".css"
            End If
        End Function
    End Class
End Namespace
