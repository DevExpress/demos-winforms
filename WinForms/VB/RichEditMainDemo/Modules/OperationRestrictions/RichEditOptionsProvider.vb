...
Namespace DevExpress.XtraRichEdit.Demos
    ...
    Public Class RichEditOptionsProvider
        ...
        Private ReadOnly _clipboardOptionsProvider As RichEditClipboardOptionsProvider

        Private ReadOnly _commonOptionsProvider As RichEditCommonOptionsProvider

        Private ReadOnly _zoomOptionsProvider As RichEditZoomOptionsProvider

        Private ReadOnly _miscellaneousOptionsProvider As RichEditMiscellaneousOptionsProvider

        Private ReadOnly _documentCapabilitiesOptionsProvider As RichEditDocumentCapabilitiesOptionsProvider
    ...
    Public Class RichEditClipboardOptionsProvider
        ...
        Private ReadOnly _options As RichEditBehaviorOptions
    ...
    Public Class RichEditDocumentCapabilitiesOptionsProvider
        ...
        Private ReadOnly _options As DocumentCapabilitiesOptions

        Private ReadOnly _numberingOptionsProvider As RichEditNumberingOptionsProvider
    ...
    Public Class RichEditNumberingOptionsProvider
        ...
        Private ReadOnly _options As NumberingOptions
