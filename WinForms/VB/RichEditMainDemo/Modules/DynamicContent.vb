...
Namespace DevExpress.XtraRichEdit.Demos
    ...
    Public Partial Class DynamicContentModule
        Inherits TutorialControl

        Public Sub New()
            InitializeComponent()
            Dim ribbonControl As RibbonControl = richEditControl.CreateRibbon(RichEditToolbarType.File Or RichEditToolbarType.Home Or RichEditToolbarType.MailMerge)
            Controls.Add(ribbonControl)
            ribbonControl.SelectedPage = ribbonControl.Pages("Mail Merge")
            LoadDocument("Dynamic Content.docx")
        End Sub
        ...
        Private Function GenerateRssFeed() As RichEditDocumentServer
            ...
            Try
                Using reader As XmlReader = SafeXml.CreateReader("https://community.devexpress.com/blogs/MainFeed.aspx")
