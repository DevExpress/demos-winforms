...
Namespace DevExpress.XtraGauges.Demos
    ...
    Public MustInherit Class BindingCollection
        ...
        Public Function IndexOf(ByVal item As Object) As Integer Implements IList.IndexOf
    ...
    Public Class Tasks
        ...
        Public Shared Function GetTasksWithPriority(ByVal collection As TasksWithCategories) As Tasks
            ...
            For i As Integer = 0 To MaxTasks - 1
                ret.List.Add(New Task(collection, i + 1, Properties.Resources.Task & (i + 1).ToString(), Date.Today.AddDays(rnd.Next(-3, 5))))
        ...
        Public Shared Function GetTasks(ByVal collection As TasksWithCategories) As Tasks
            ...
            Dim rnd = Data.Utils.NonCryptographicRandom.Default
            For i As Integer = 0 To MaxTasks - 1
                ret.List.Add(New Task(collection, i + 1, Properties.Resources.Task & (i + 1).ToString(), Date.Today.AddDays(rnd.Next(5))))
                If i = 2 Then
