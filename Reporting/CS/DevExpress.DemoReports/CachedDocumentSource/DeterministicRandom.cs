...
namespace XtraReportsDemos.CachedDocumentSourceReport {
    class DeterministicRandom {
        ...
        static DeterministicRandom() {
            ...
            DevExpress.Data.Utils.NonCryptographicRandom currentRandom = new DevExpress.Data.Utils.NonCryptographicRandom(randomCount);
        ...
        int rnd;
        int Next {
            get { return rnd = deterministicRandomNumbers[rnd % randomCount]; }
        }
        public char RandomChar {
            get { return (char)((int)'A' + Random(0, 26)); }
        }
